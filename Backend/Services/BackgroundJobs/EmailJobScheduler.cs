...
public class EmailJobScheduler : IEmailJobScheduler
{
    ...
    public async Task QueueVerificationEmailAsync(
        string email,
    ...
    public async Task QueuePasswordResetEmailAsync(
        string email,
        string resetToken,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task QueueSubscriptionSuccessEmailAsync(
        string email,
        string planName,
        decimal amount,
        CancellationToken cancellationToken = default)
    ...
    public async Task QueueSubscriptionCancellationEmailAsync(
        string email,
        string planName,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task QueueSubscriptionExpiryEmailAsync(
        string email,
        string planName,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task QueueQuotaWarningEmailAsync(
        string email,
