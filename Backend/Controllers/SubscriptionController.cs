...
public class SubscriptionController : ControllerBase
{
            ...
            CancellationToken cancellationToken)
    {
        ...
        {
            return NotFound(
                "No active subscription or active grace period was found.");
        }
    ...
    public async Task<ActionResult<SubscriptionResponseDto>> Renew(
        [FromBody] RenewSubscriptionRequestDto request,
        CancellationToken cancellationToken)
    {
        var userId =
            GetAuthenticatedUserId();
        ...
        var response =
            await _subscriptionService.RenewAsync(
                userId,
                request,
                cancellationToken);
    ...
    [HttpPost("cancel")]
    public async Task<ActionResult<SubscriptionResponseDto>> Cancel(
        CancellationToken cancellationToken)
    {
        var userId =
            GetAuthenticatedUserId();
