...
export function AuthVisual() {
  ...
  return (
    <div ref={visualRef}>
      <SceneErrorBoundary label={label} imageSrc={fallbackSrc}>
        <Suspense fallback={<SceneFallback label={label} imageSrc={fallbackSrc} />}>
          <LazyThreeScene label={label} fallbackSrc={fallbackSrc}>
