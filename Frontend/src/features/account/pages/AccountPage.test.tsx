...
vi.mock('@/features/account/components/ProfileForm', () => ({ ProfileForm: () => <p>Profile success state</p> }))
vi.mock('@/features/account/components/ChangePasswordForm', () => ({ ChangePasswordForm: () => <p>Password form</p> }))
...
describe('AccountPage states', () => {
  beforeEach(() => {
    ...
    vi.mocked(useLogout).mockReturnValue({ mutate: logoutMutate, isPending: false } as unknown as ReturnType<typeof useLogout>)
  })
  ...
  it('offers retry after a profile error', () => {
    vi.mocked(useProfile).mockReturnValue({ isPending: false, isError: true, isFetching: false, refetch } as unknown as ReturnType<typeof useProfile>)
    render(<MemoryRouter><AccountPage /></MemoryRouter>)
  ...
  it('renders profile, password, and logout controls after success', () => {
    vi.mocked(useProfile).mockReturnValue({ isPending: false, isError: false, data: {} } as unknown as ReturnType<typeof useProfile>)
    render(<MemoryRouter><AccountPage /></MemoryRouter>)
